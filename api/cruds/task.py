...
class AsyncSession(eversibleProxy):
    async def execute(
        self, statement, params: Any | None = ..., execution_options=...,
        bind_arguments: Any | None = ..., **kw
    ): ...

class FromClause(Selectable):
    def outerjoin(self, right: FromClause,
    onclause: Optional[ClauseElement] = ..., full: bool = ...) -> Join: ...
...
class AsyncSession(ReversibleProxy):
    ...
    async def refresh(self, instance, attribute_names: Any
    | None = ..., with_for_update: Any | None = ...): ...
